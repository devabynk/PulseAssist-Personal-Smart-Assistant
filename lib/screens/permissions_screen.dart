...
class _PermissionsScreenState extends State<PermissionsScreen> {
  ...
  Future<void> _requestExactAlarmPermission() async {
    ...
    try {
      final granted = await NotificationService.instance.requestExactAlarmPermission();
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Optional permissions notice (only show if not all granted)
                   if (!_notificationGranted || (Platform.isAndroid && !_exactAlarmGranted) || !_microphoneGranted || !_cameraGranted || !_storageGranted)
                    Container(
                      padding: const EdgeInsets.all(12),
                      decoration: BoxDecoration(
                        color: isDark 
                  ...
                  _buildPermissionCard(
                    ...
                    onTap: _notificationGranted ? null : _requestNotificationPermission,
                    isDark: isDark,
                  ...
                  if (Platform.isAndroid)
                    _buildPermissionCard(
                      ...
                      onTap: _exactAlarmGranted ? null : _requestExactAlarmPermission,
                      isDark: isDark,
                      grantText: l10n.grant,
                    ),
                  ...
                  _buildPermissionCard(
                    ...
                    onTap: _microphoneGranted ? null : _requestMicrophonePermission,
                    isDark: isDark,
                    grantText: l10n.grant,
                  ),
                      ...
                      Expanded(
                        child: ElevatedButton(
                          ...
                          child: _isLoading
                              ...
                              : Text(
                                  widget.fromSettings ? l10n.save : l10n.continueButton,
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              color: isDark
                                  ...
                                  : Theme.of(context).textTheme.bodyMedium?.color?.withAlpha(180)??Colors.grey[600],
                              fontSize: 11,
                            ),
                          ),
                        ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isGranted ? AppColors.primary.withAlpha(100) : Colors.transparent,
            width: 2,
          ),
          boxShadow: isDark
              ? null
        ...
        child: Row(
          children: [
            ...
            IconButton(
              icon: Icon(Icons.info_outline, size: 20, color: AppColors.primary.withAlpha(180)),
