...
class AppTheme {
  ...
  static final EdgeInsets _defaultPadding = const EdgeInsets.symmetric(horizontal: 20, vertical: 16);

  static TextTheme _buildTextTheme(ThemeData base, Color primary, Color secondary) {
    return GoogleFonts.outfitTextTheme(base.textTheme).copyWith(
      ...
      displaySmall: GoogleFonts.outfit(fontSize: 36, fontWeight: FontWeight.bold, color: primary),
      headlineLarge: GoogleFonts.outfit(fontSize: 32, fontWeight: FontWeight.bold, color: primary),
      ...
      titleMedium: GoogleFonts.outfit(fontSize: 18, fontWeight: FontWeight.w500, color: primary), 
      titleSmall: GoogleFonts.outfit(fontSize: 16, fontWeight: FontWeight.w500, color: secondary),
      bodyLarge: GoogleFonts.outfit(fontSize: 16, fontWeight: FontWeight.normal, color: primary),
      bodyMedium: GoogleFonts.outfit(fontSize: 14, fontWeight: FontWeight.normal, color: secondary),
      bodySmall: GoogleFonts.outfit(fontSize: 12, fontWeight: FontWeight.normal, color: secondary),
      labelLarge: GoogleFonts.outfit(fontSize: 14, fontWeight: FontWeight.w600, color: primary),
    );
  }

  static InputDecorationTheme _buildInputDecorationTheme(Color fillColor, Color borderColor, Color hintColor) {
  ...
  static ThemeData get darkTheme {
    ...
    return ThemeData(
      ...
      textTheme: _buildTextTheme(base, AppPalette.textPrimaryDark, AppPalette.textSecondaryDark),
      primaryTextTheme: _buildTextTheme(base, AppPalette.textPrimaryDark, AppPalette.textSecondaryDark),
      appBarTheme: AppBarTheme(
        backgroundColor: AppPalette.darkBackground,
        foregroundColor: AppPalette.textPrimaryDark,
        elevation: 0,
        centerTitle: false,
        titleTextStyle: GoogleFonts.outfit(fontSize: 22, fontWeight: FontWeight.bold, color: AppPalette.textPrimaryDark),
        iconTheme: const IconThemeData(color: AppPalette.textPrimaryDark),
      ),
      iconTheme: const IconThemeData(color: AppPalette.textPrimaryDark),
      inputDecorationTheme: _buildInputDecorationTheme(AppPalette.darkSurface, Colors.transparent, AppPalette.textSecondaryDark),
      ...
      dialogTheme: DialogThemeData(
        ...
        titleTextStyle: GoogleFonts.outfit(fontSize: 20, fontWeight: FontWeight.bold, color: AppPalette.textPrimaryDark),
        contentTextStyle: GoogleFonts.outfit(fontSize: 16, color: AppPalette.textSecondaryDark),
      ),
  ...
  static ThemeData get lightTheme {
    ...
    return ThemeData(
      ...
      textTheme: _buildTextTheme(base, AppPalette.textPrimary, AppPalette.textSecondary),
      primaryTextTheme: _buildTextTheme(base, AppPalette.textPrimary, AppPalette.textSecondary),
      appBarTheme: AppBarTheme(
        backgroundColor: AppPalette.lightBackground,
        foregroundColor: AppPalette.textPrimary,
        elevation: 0,
        centerTitle: false,
        titleTextStyle: GoogleFonts.outfit(fontSize: 22, fontWeight: FontWeight.bold, color: AppPalette.textPrimary),
        iconTheme: const IconThemeData(color: AppPalette.textPrimary),
      ),
      iconTheme: const IconThemeData(color: AppPalette.textPrimary),
      inputDecorationTheme: _buildInputDecorationTheme(AppPalette.lightSurface, Colors.transparent, AppPalette.textSecondary),
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          backgroundColor: AppPalette.primary,
          foregroundColor: Colors.white,
      ...
      dialogTheme: DialogThemeData(
        backgroundColor: AppPalette.lightSurface,
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(24)),
        titleTextStyle: GoogleFonts.outfit(fontSize: 20, fontWeight: FontWeight.bold, color: AppPalette.textPrimary),
        contentTextStyle: GoogleFonts.outfit(fontSize: 16, color: AppPalette.textSecondary),
      ),
      bottomNavigationBarTheme: BottomNavigationBarThemeData(
        backgroundColor: AppPalette.lightSurface,
        selectedItemColor: AppPalette.primary,
